 ...
 * @author Jhordie
 */
public class TableFuentes extends javax.swing.JFrame {

    /**
     * Creates new form TableFuentes
     */
    public TableFuentes() {
        initComponents();
        // cuando se crea la ventana se llena la tabla con las fuentes
        cargarDatos();


    }
    //funcion que obtienen las fuentes de la base de datos y las muestra en la tabla
    public void cargarDatos(){
        try{
            ...
            while (resultSet.next()) {
                ...
                DefaultTableModel model = (DefaultTableModel) tblFuentes.getModel();
                model.addRow(new Object[]{source, author});
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableFuentes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TableFuentes().setVisible(true);
            }
        });
    }
